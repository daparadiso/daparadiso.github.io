...
Outreach in all different forms has always been one of my main priorities as a scientist. Below I discuss two of my favorite outreach initiatives that I have been a part of, but please see my [CV](https://daparadiso.github.io/files/CV.pdf) for a complete list of the outreach projects I have taken part in.
...
In addition to mentoring specific students on research projects, Since 2023 I have organized and led a week-long computational bootcamp for all 24 students participating in the program. During this "bootcamp" I introduced the students to computational tools that are crucial for conducting research, including: utilizing the command line (bash scripting) and data analysis with Python.
